...
namespace WhatsAppSimHubPlugin.Core
{
    public class WebSocketManager
    {
        ...
        public WebSocketManager(string pluginPath)
        {
  ...
  ""dependencies"": {
    ...
    ""puppeteer"": ""^21.0.0""
        ...
        private void EnsureServerScript()
        {
            var scriptPath = Path.Combine(_pluginPath, "node", "whatsapp-server.js");
            
            // Ler JavaScript do Resource embutido
            var assembly = Assembly.GetExecutingAssembly();
            var resourceName = "WhatsAppSimHubPlugin.Resources.whatsapp-server.js";
